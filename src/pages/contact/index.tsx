...
const Contact: FC = () => {
  ...
  return (
    <section className="bg-black pb-15 pt-40">
      <div className="bg-contact-1"></div>
      <Container>
        ...
        <div className="flex gap-12">
          ...
          <div className="w-2/4">
            ...
            <p className="text-white text-xl">
              ...
              รวมทั้งเครื่องแต่งกายสำหรับขับขี่เพื่อความปลอดภัย อาทิ หมวกกันน็อค
              เสื้อการ์ด ถุงมือ ฯลฯ เพื่อรองรับการขับขี่ในชีวิตประจำวัน
              กิจกรรมการเดินทางออกทริป เพิ่มความสะดวกสบาย (อุปกรณ์สัมภาระ)
              การแต่งสวยงาม (จัดสภาพ) และเพิ่มประสิทธิภาพ (ระบบเบรก)
            </p>
            <p className="text-white text-xl">
        ...
        <div className="pt-15 flex gap-12">
          <div className="w-2/4">
            ...
            <p className="text-white text-xl">
              ...
              ผู้ขับขี่ เมื่อขับขี่รถของตน ก็เหมือนผู้นำที่ต้องการไปสำรวจเดินทาง
              สู่อิสระ และไปสัมผัสธรรมชาติ ให้{' '}
              <span className="text-primary">&quot;ลมมันปะทะตัว&quot;</span>{' '}
              มันคือความสุข
            </p>
            <p className="text-white text-xl">
              <span className="text-primary">สิ่งอำนวยความสะดวกภายในร้าน</span>{' '}
              : ร้านสะอาดปลอดภัย มีพื้นที่ชั้นวางสินค้า พื้นที่บริการเซอร์วิส
              ห้องรับรองลูกค้า น้ำดื่มเย็น กาแฟ ชา ของว่าง นอกจากนี้ยังมีบริการ
              FREE WIFI, TV และ พื้นที่สูบบุหรี่ ไว้บริการลูกค้า
            </p>
          </div>
          <div className="w-2/4">
            <Image
        ...
        <div className="pt-15 pb-25 flex gap-12">
          ...
          <div className="w-2/4">
            ...
            <p className="text-white text-xl">
              ...
              และการนำขยะกลับมาใช้ใหม่ (Recycle) สามารถช่วยลดปริมาณขยะให้น้อยลง
              และปฏิบัติตามข้อกำหนดกฏหมาย
